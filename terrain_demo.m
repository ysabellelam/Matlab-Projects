...
%This function solves equations to describe missile movement 
%inputs initial position, mass, and thrust magnitude of missile as well as the final mass, angles theta and phi, and the fuel burn time 
%outputs Time, position, and velocity of the missile  
load('terrain.mat')
